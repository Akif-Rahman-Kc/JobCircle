                                    ...
                                    {chats.map((chat)=>(
                                        ...
                                        <IconButton onClick={()=>{
                                          ...
                                          setCurrentChat(chat)
                                            ...
                                            <MessageSideOne data={chat} currentUserId={user._id} online={checkOnlineStatus(chat)} refresh={refresh}/>
                                        </IconButton>
                                        <hr />
                                        </>
                                    ))}
                                ...
                                <Box className='comments' sx={{ overflowY:'auto' , width:'100%' , height:'56vh' }}>
                                    ...
                                    {chats.map((chat)=>(
                                        ...
                                        <IconButton onClick={()=>{
                                            ...
                                            <MessageMobileSideOne data={chat} currentUserId={user._id}  online={checkOnlineStatus(chat)} refresh={refresh}/>
                                        </IconButton>
                                        <hr />
                                        </>
                                    ))}
